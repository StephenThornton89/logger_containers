...
public class Main extends JFrame implements ActionListener, ChangeListener {
	...
	public Main() throws Exception {
		...
		StatsPanel listPanel = new StatsPanel("List", new String[] { "Stack", "CopyOnWriteArrayList", "Vector" });
		...
		StatsPanel mapPanel = new StatsPanel("Map", new String[] { "ConcurrentSkipListMap", "IdentityHashMap", "WeakHashMap", "ConcurrentHashMap" });
